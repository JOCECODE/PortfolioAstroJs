...
function Nav() {
  return (
    <nav className={Styles.nav}>
      ...
      <a title="LinedIn Profile" className={Styles.social} href="https://www.linkedin.com/in/jose-u-perez-jr/" target="_blank" rel="noreferrer noopener">
      ...
      <a title="Resume" href="https://docs.google.com/document/d/1uvdayI4uSEahfE8jJxs03TZfWyIwOzSvW7L7H3s-Eos/edit?usp=sharing" target="_blank" rel="noreferrer noopener">
      ...
      <a title="Github Profile" href="https://github.com/JOCECODE" target="_blank" rel="noreferrer noopener">
